...
class PostResyclerAdapter(var context: Context, var mRecyclerView: RecyclerView, var items: MutableList<ObjPost?>) :
    RVAdrMutableNullable<ObjPost?, RecyclerView.ViewHolder>(items) {
